...
--   hl.exec_cmd("nm-applet")
     ...
     hl.exec_cmd("solaar")
     hl.exec_cmd("sleep 1 && pkill solaar")
end)
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(9098cbff)", "rgba(fc92fcff)"}, angle = 45 },
...
hl.config({
    input = {
        ...
        sensitivity = -0.68, -- -1.0 - 1.0, 0 means no modification.
...
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd(hyprshot))
